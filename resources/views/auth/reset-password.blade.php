              ...
              <div class="card-body">
                <form  class="text-start"method="POST" action="{{ route('login') }}">
                  ...
                  <div class="input-group input-group-outline my-3" data-validate= "Please enter Username">
                    <input type="email" name="email" placeholder="Email" value="{{ $request->email }}" class="form-control">
                  </div>
                  <div class="input-group input-group-outline mb-3" data-validate = "Please enter password">
                    <input type="password" name="password" placeholder="Password" required autocomplete="new-password" class="form-control" >
                  </div>
                  <div class="input-group input-group-outline mb-3" data-validate = "Please enter password">
                    <input type="password" name="password_confirmation" placeholder="Confirm Password" required autocomplete="new-password" class="form-control" >
                  </div>
                  <div class="container-login100-form-btn">
                    <button class="login100-form-btn btn bg-gradient-primary w-100 my-4 mb-2">Reset Password</button>
                    </div>
                </form>
              </div>
            </div>
